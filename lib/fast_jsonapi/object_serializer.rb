...
module FastJsonapi
  module ObjectSerializer
    ...
    def hash_for_one_record
      ...
      serializable_hash[:included] = self.class.get_included_records(@resource, @params, @includes, @known_included_objects) if @includes.present?
      serializable_hash
    end
    ...
    def hash_for_collection
      ...
      @resource.each do |record|
        ...
        included.concat self.class.get_included_records(record, @params, @includes, @known_included_objects) if @includes.present?
      end
